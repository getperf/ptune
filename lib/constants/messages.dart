...
この操作を続けますか？''';
  ...
  static String get initConfirm =>
      '''
Google Tasks に ${EnvConfig.taskListTitle} タスクリストを新規作成します（既存がなければ）。
この操作は最初の一回のみ必要です。
この操作を続けますか？''';
}
...
class SyncLabels {
  ...
  static String get initNote =>
      'Google Tasks に ${EnvConfig.taskListTitle} タスクリストを登録します。初回のみ実行してください。';
